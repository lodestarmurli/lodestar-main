...
public class ClientStudentDetailsDTO implements IModel
{
	...
	private DHStudentTypeEnum			studentType;
	...
	public DHStudentTypeEnum getStudentType()
	{
		return studentType;
	}

	public void setStudentType(DHStudentTypeEnum studentType)
	{
	...
	public String toString() {
		return "ClientStudentDetailsDTO [id=" + id + ", clientID=" + clientID + ", clientName=" + clientName + ", name="
				+ name + ", cityId=" + cityId + ", classStr=" + classStr + ", schoolName=" + schoolName + ", stream="
				+ stream + ", contactNumber=" + contactNumber + ", fathername=" + fatherName + ", fatheremailId="
				+ fatheremailId + ", computerFacility=" + computerFacility + ", userId=" + userId + ", gender=" + gender
