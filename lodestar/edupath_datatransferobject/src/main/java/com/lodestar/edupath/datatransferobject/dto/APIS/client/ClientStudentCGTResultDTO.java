...
public class ClientStudentCGTResultDTO implements IModel {
	...
	public String toString() {
		return "ClientStudentCGTResultDTO [id=" + id + ", studentId=" + studentId + ", clientID=" + clientID
				+ ", clientName=" + clientName + ", personalityCode=" + personalityCode + ", score=" + score
				+ ", aptitudeComplete=" + aptitudeComplete + ", appScore=" + appScore + ", ssFactor=" + ssFactor
				+ ", occupationIds=" + occupationIds + ", occId1=" + occId1 + ", occId2=" + occId2 + ", token1="
				+ token1 + ", token2=" + token2 + ", pdfToken=" + pdfToken + "]";
	}
