...
public interface Notifiable extends Serializable
{
	 ...
	 */
	void setNotificationSent(boolean isNotificationSent);
	 ...
	 * @return
	 */
	boolean isNotificationInProgress();

	/**
	 * @param notificationInProgress
	 */
	void setNotificationInProgress(boolean notificationInProgress);
}
