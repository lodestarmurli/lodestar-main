...
public class DHStudentCGTDAO
{
	private static final Logger	OUT	= LoggerFactory.getLogger(DHStudentCGTDAO.class);

	public List<DHStudentCGTDTO> getDHStudentCGTByStudentId(int studentId) throws Exception
	{
		List<DHStudentCGTDTO> list = MyBatisManager.getInstance().getResultList(MyBatisMappingConstants.GET_DHSTUDENT_CGT_BY_STUDENTID, studentId);
		return list;
	}
	public List<DHStudentCGTDTO> getDHStudentCGTAptitudeByStudentId(int studentId) throws Exception
	{
		List<DHStudentCGTDTO> list = MyBatisManager.getInstance().getResultList(MyBatisMappingConstants.GET_DHSTUDENT_CGT_APTITUDE_BY_STUDENTID, studentId);
		return list;
	}
//
