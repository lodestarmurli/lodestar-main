...
public class ClientStudentCGTDAO
{
	private static final Logger	OUT	= LoggerFactory.getLogger(ClientStudentCGTDAO.class);

	public List<ClientStudentCGTDTO> getDHStudentCGTByStudentId(int studentId) throws Exception
	{
		List<ClientStudentCGTDTO> list = MyBatisManager.getInstance().getResultList(MyBatisMappingConstants.GET_CLIENTSTUDENT_CGT_BY_STUDENTID, studentId);
		return list;
	}
	public List<ClientStudentCGTDTO> getDHStudentCGTAptitudeByStudentId(int studentId) throws Exception
	{
		List<ClientStudentCGTDTO> list = MyBatisManager.getInstance().getResultList(MyBatisMappingConstants.GET_CLIENTSTUDENT_CGT_APTITUDE_BY_STUDENTID, studentId);
		return list;
	}
//
