...
<c:choose>	
	<c:when test="${interestCompleted eq true}">
		...
		<jsp:include page="/pages/Partnerpages/TestCompleted.jsp"></jsp:include>
	...
	<c:otherwise>
		   ...
		   <div id="instruction" >
		     ...
		     <jsp:include page="/pages/Partnerpages/TestStarting.jsp"></jsp:include>
		     
		   </div>
		 
		  <div id="instruction1" style="display:none;" >
		     
		     <jsp:include page="/pages/Partnerpages/Testinstruction.jsp"></jsp:include>
		     
		   </div>
		 
		 <!--Question Start-->
		 <section class="cd-faq">
		 <div class="cd-faq-items" style="margin-top:26px;">
		     ...
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I like to understand how different machines and equipments work?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_2">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I enjoy reading about scientific inventions and discoveries?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_4">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">To participate in co - curricular activities, I choose projects that involve working with others than participate in debates, competitions, etc.?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_6">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I prefer to keep a track of my pocket money?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_7">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I prefer to understand the parts of the gadgets - phone, airplanes,computers etc., than follow a process to create a software?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_9">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">If given a chance, I would like to be a part of musical/ theatrical troupe and tour the world to perform?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_10">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">If given a choice, I like to participate in activities that require group interaction than in art work?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_16">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">Helping / teaching people interests and motivates me than leading people in projects?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_17">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">For group projects, I like to decide and assign tasks for people than be in-charge of the material (gadgets, stationery etc.,) required?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_18">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I usually have a fixed time-table for completing my daily tasks?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_19">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I enjoy working with plants, trees, gadgets, machines etc?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_20">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I enjoy tasks that require researching on new topics than leading people to work on tasks?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_22">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I would enjoy teaching science than conduct science experiments?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_23">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">It is important for me to express my opinion, in any group discussion?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_24">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I prefer to work on assignments that have fixed processes/ steps than those which have to be studied?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_26">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I find working in science labs to conduct experiments more fascinating than participating in debates, competitions, etc?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_31">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">If given a choice, I would like to be play outdoors than be indoors drawing or painting?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_36">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">If given a choice, as part of a project, I would like to follow the steps to complete the project than start up or initiate ideas?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_39">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I dream of being an novelist / author one day?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_46">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I like to volunteer for social causes such as helping the elderly at old age homes; volunteering at orphanages, school for the differently abled people etc?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
		   ...
		   <div class="qusetion_content" style="display: none" id="qusetion_content_60">
		     <div class="col-md-9">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">I prefer to explain using diagrams and flow-charts than build working models for science projects?</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-3">
...
$(document).ready(function(){
  ...
  $('.btn_qt').click(function()
  {
	  ...
	  fnAutoSaveForInterest('Psychometrictests');
   });
