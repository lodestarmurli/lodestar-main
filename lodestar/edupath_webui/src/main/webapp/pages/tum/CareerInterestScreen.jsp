...
<div class="rows">
  ...
  <div class="col-md-12">
   <div class="col-md-10">
    <div class="div_lable qusetion_txt">
     <div class="question_left_div">11.&nbsp;&nbsp;</div>
      <div class="question_right_div">
        <p class="qusetion_txt">What do you want to become in life ? What kind of work do you want to do when you grow up?</p>
      </div>
    </div>
  ...
  <div class="col-md-12">
   <div class="col-md-9">
    <div class="div_lable qusetion_txt qusetion_txt">
      <div class="question_left_div">12.&nbsp;&nbsp;</div>
      <div class="question_right_div">
  ...
  <div class="col-md-12">
   <div class="col-md-9">
    <div class="div_lable qusetion_txt">
     <div class="question_left_div">13.&nbsp;&nbsp;</div>
      <div class="question_right_div">
  ...
  <div class="col-md-12 action-div">
      ...
      <button class="btn btn_action btn-submit " onclick="fnStudentTUMFinalSubmit('CareerinterestAction');"><span class="next-spn"><s:text name="com.edupath.common.label.submit"></s:text></span></button>  <!-- 22/03/18-->
   </div> 
</div>
