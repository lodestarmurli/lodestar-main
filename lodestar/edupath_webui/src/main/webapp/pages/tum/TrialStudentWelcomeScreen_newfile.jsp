...
<div id="mainPage_2">
  <div class="row">
   <!--Content 2  -->
     <div class="col-md-12 col-xs-12" style="padding-top: 20;">
      <div class="instruction_txt_div">
             <div class="change_icon_left_div col-xs-12 col-md-2" >
                  <img alt="" src="../images/icons/welcome-TUM.gif" class="img-responsive" >
             </div>
             <div class="change_right_div change_p_h6 col-xs-12 col-md-10">
