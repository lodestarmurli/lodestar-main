...
<c:choose>	
	<c:when test="${interestCompleted eq true}">
		<div class="modal fade in" id="interestCompletedMsgModal" role="dialog" >
			     ...
			     <!-- Modal content-->
			   	<div class="modal-content">
			       	...
			       	<div class="modal-body" style="text-align: center;">
			         		<p style="font-size: 11pt"><s:text name="com.edupath.questionnarie.interest.already.compleated.message"></s:text></p>
			       	</div>
	...
	<c:otherwise>
		<div class="rows edupath-padding">
		<!--Instruction start -->
		 <div class="clo-md-12" style="  padding-top: 10px;padding-left: 25px;">
		 <%-- <div class="pagetitle">
		       <span><s:text name="com.edupath.questionnarie.interest.instruction.label"></s:text></span>
		     </div> --%>
		   <div id="instruction" >
		       ...
		       <ul>
		         <li>
		           <div class="instruction_txt_div">
		             ...
		             <div class="instruction_right_div">
		                The Interest Test aims to understand your key interest areas and activities which you enjoy doing the most. 
		           		This Interest Test has 60 statements. 
		           		You will need <b>20-25 Minutes</b> to complete this section.
		             </div>
		           </div>
		         </li>
		         <li>
		          <div class="instruction_txt_div">
		           ...
		           <div class="instruction_right_div">
		              <span>
		              Kindly respond to each statement by choosing one of the options from the two possible response options provided <b>(YES or NO)</b>.
		           </span>
		           </div>
		          </div>
		         </li>
		         <li>
		          <div class="instruction_txt_div">
		            ...
		            <div class="instruction_right_div">
		               <span>
		                Carefully read the statements and give the first response thought which comes to your mind. DO NOT spend lot of time on one statement.
		              </span>
		            </div>
		          </div>
		         </li>
		         ...
		         <div class="instruction_txt_div">
		            ...
		            <div class="instruction_right_div">
		              <span>
		               Your responses shall be kept confidential.
		             </span>
		            </div>
		          </div>
		         </li>
		...
		<div class="row" id="interest_process_btns">
			<div class="col-md-12  remove_div" >
				<button class="btn btn_action" onclick="fnStartInterestTest();" style="margin-right: 50px;">
			    	<span class="next-spn" style="padding-left:0px; padding-right:0px"><s:text name="com.edupath.questionnarie.start"></s:text></span>
			   	</button>
			    <button class="btn btn_action" onclick="fnGoBack('param');" >
		...
		<%--  <div class="qusetion_container">
		  <c:forEach items="${questionList}" var="question" varStatus="count">
		   <div class="qusetion_content" style="display: none" id="qusetion_content" >
		     <div class="col-md-10">
		         <div class="qusetion_txt">
		            ...
		            <div class="qusetion_right_div">
		             <p class="question_p">${question}</p>
		            </div>
		          </div>
		     </div>
		    <div class="col-md-2">
		       <div class="btn-group">
		         <input type="hidden" id="answer_${count.index + 1}">
		         <button type="button" class="btn btn_qt " data-answer="YES" data-serial="${count.index + 1}" id="yes_${count.index + 1}"><s:text name="com.edupath.questionnarie.yes"/></button>
		         <button type="button" class="btn btn_qt " data-answer="NO" data-serial="${count.index + 1}" id="no_${count.index + 1}"><s:text name="com.edupath.questionnarie.no"/></button>
		       </div>
		    </div>
		  </div>
		  </c:forEach>
...
$(document).ready(function(){
  ...
  $('.btn_qt').click(function()
  {
	  ...
	  fnAutoSaveForInterest('InterestAction');
   });
  ...
  function fnSubmitInterestForm()
  {
	  if(isAllAnswered())
	  {
		  $('#interestSubmitMsgModal').modal("show");
	  }
	  else
	  {
		  $('#questionMadatoryModal').modal("show");
  ...
  {
	  //fnAnswerFormSubmit('InterestAction');
	  fnAnswerFormSubmitInteresttest('InterestAction');
