...
<div class="rows">
  ...
  <div class="col-md-12">
   <div class="col-md-12">
    ...
    <div class="txt-field strength_div">
     ...
     <div class="rows">
       ...
       <c:forEach begin="${start}" end="${end}" var="item" varStatus="count">
         <c:if test="${item lt fn:length(strengths) }">
          <div class="col-md-4 col-lg-4 custom-box">
  ...
  <div class="col-md-12">
   <div class="col-md-8">
    ...
    <div class="txt-field strength_div " style="padding-left:35px">
     ...
     <div class="rows">
       ...
       <c:forEach begin="${start}" end="${end}" var="item" varStatus="count">
         <c:if test="${item lt fn:length(subjectOrArea) }">
          <div class="col-md-4 custom-box-subject">
            <div class="checkbox checkbox-primary">
            	<c:choose>
	    ...
	    <!-- Modal content-->
	   	<div class="modal-content" style="">
	       	...
	       	<div class="modal-body">
	        		...
	        		<p>
You enjoy working on gadgets / objects for the purpose of repairing or re-organizing / re-modeling it. For example: You usually like to open up gadgets such as clocks, phones, watches or any household appliance to understand the mechanics or the workings of it.	        			 
	        		</p>
