...
<div id="mainPage_2" style="display: none;">
  <div class="row">
   <div class="col-md-12 change_page_div_1">
    ...
    <!--Content 1  -->
   <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="padding-top: 20;">
      <div class="instruction_txt_div">
             <div class="change_icon_left_div  col-xs-12 col-lg-2 col-sm-6 col-md-2">
                 <img alt="" src="../images/icons/welcome-TUM.gif" class="img-responsive">
             </div>
             <div class="change_right_div change_p_h6 col-xs-12 col-lg-10 col-sm-6 col-md-10">
  ...
  <div class="row " style="padding-left: 17px;">
      ...
      <button class="btn btn_action btn-back change_back_btn" onclick="fnBack();" style="margin-top:10px"><span class="back-spn"><s:text name="com.edupath.common.label.back"></s:text></span></button>
      <button class="btn btn_action btn-back change_back_btn" onclick="fnGetStart();" style="margin-top:10px" ><span class="back-spn"><s:text name="com.edupathstudent.tum.welcome.getstart"></s:text></span></button>
   </div> 
</div>   
