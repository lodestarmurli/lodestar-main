...
<div class="rows">
  ...
  <div class="col-md-12 col-xs-12">
    ...
    <div class="row">
      <div class="col-md-6 marks_lable" style="padding-bottom: 15px;">
       <div class="radio radio-success radio-inline">
             <input type="radio" id="percentages_1" value="percentage" data-serial="4"  name="mark" class="marks_input" checked="checked"/>
             <label for="percentages_1">Percentage</label>
        </div>
         <div class="radio radio-success radio-inline">
             <input type="radio" id="grades_1" value="grade" data-serial="4"  name="mark" class="marks_input" />
       ...
       <div class="rows">
        <span class="error-block" id="subject_error"></span>
         <div class="col-md-1 sr-number subject_div col-xs-12">
           <span>Sr. No</span>
         </div>
         <div class="col-md-4 subject_div col-xs-12">
           <span>Subjects Studied in Class 12th</span>
         </div>
         <div class="col-md-4  subject_div col-xs-12" >
           <span class="mark_title">Percentage obtained in the last examination</span>
         </div>
  ...
  <s:iterator begin="1" end="6" status="rowstatus" var="count">
   <div class="col-md-12 col-xs-12" style="padding-left: 40px;">
    <div class="col-md-11 col-xs-12">
     <div class="rows">
           <div class="col-md-1 col-xs-12 row_div sr-number row_${rowstatus.odd}">
             ${count} 
           </div>
           <div class="col-md-4  col-xs-12 row_div row_${rowstatus.odd}">
             <div class="selectdiv">
           ...
           <div class="col-md-4 col-xs-12 row_div row_${rowstatus.odd}" style="text-align: center;">
               <s:textfield name="grade"  cssClass="input-sml grade_input change_input " id="grade_%{count}"  data-index='%{count}' placeholder="Enter %" onblur="fnTextSave();" ></s:textfield>
           </div>
       </div>
    </div>
   </div>
...
function fnSetMarks(value)
{
	...
	{
		$('.mark_title').html('');
		$('.mark_title').html('Percentage obtained in the last examination');
	...
	else
	{
		...
		$('.mark_title').html('');
		$('.mark_title').html('Grade obtained in the last examination');
