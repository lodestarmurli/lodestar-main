...
<script type="text/javascript">
	...
	function fnReloadWishList()
	{
		...
		$.ajax({
			  url: "${pageContext.request.contextPath}/jsonapp/occupationListOccupationClusterWishList",
	...
	function fnUpdateWishList(result)
	{
        ...
        $(result.studentWishList).each(function(i, occupationlist){
        	...
        	console.log("bharath writing whistListSizeFromJS=>>"+whistListSizeFromJS)
                ...
                //{
                	console.log("bharath fnUpdateWishList occupationlist[index].occupation=>"+occupationlist)	
	...
	function fnDeleteFromWishListById(wishListId)
	{
		...
		$.ajax({
			  url: "${pageContext.request.contextPath}/jsonapp/deleteOccupationClusterWishList?option=optionB",
			  data:{
	...
	function fnSubmitWishList(occId, showDialog)
	{
		...
		$.ajax({
			  url: "${pageContext.request.contextPath}/jsonapp/addOptionBOccupationClusterWishList",
			  data:{
				  		"wishId": occId,
	...
	function fnConfirmSubmit()
	{
		...
		form.action = "${pageContext.request.contextPath}/jsonapp/submitOccupationClusterWishList?option=optionB";
		form.submit();
	}
