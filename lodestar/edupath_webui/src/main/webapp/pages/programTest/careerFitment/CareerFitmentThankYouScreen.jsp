	...
	<div id="mainPage_1">
		...
		<div class="row">
			<div class="col-md-12 change_page_div_1">
						...
						<br>
						<p class="change_p_h4">Based on your Vocational Personality and Aptitude Test results your <b>Career Fitment</b> to your three chosen careers <b> ${wishListStr}</b> has been generated by the Lodestar Career Guidance System.</p>
						<br>
						
						<button class="btn btn_action" onclick="fnDownloadCareerFitmentReport();" style="margin-right: 50px;" >
					    		<span class="next-spn" style="padding-left:0px; padding-right:0px"><s:text name="Download Career-Fitment Report"></s:text></span>
					   	</button>
