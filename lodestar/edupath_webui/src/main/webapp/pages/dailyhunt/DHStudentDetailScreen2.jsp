		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					...
					<s:text name="com.DailyHunt.Student.Conversion.Title" />
				</div>
			...
			<div class="portlet-body">
				...
				<s:form cssClass="form-horizontal" name="studentSubmitForm"
					...
					<s:hidden id="contactNumber" name="contactNumber"></s:hidden>
					<s:hidden id="fatherName" name="fatherName"></s:hidden>
					<s:hidden id="fatherEmailId" name="fatherEmailId"></s:hidden>
					<s:hidden id="computerFacility" name="computerFacility"></s:hidden>
					<s:hidden id="gender" name="gender"></s:hidden>
					<s:hidden id="motherName" name="motherName"></s:hidden>
					<s:hidden id="motheremailId" name="motheremailId"></s:hidden>
					<s:hidden id="mothercontactno" name="mothercontactno"></s:hidden>
					<s:hidden id="studentemailId" name="studentemailId"></s:hidden>
					<s:hidden id="studentcontactNumber" name="studentcontactNumber"></s:hidden>
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-3"> <s:text
									name="com.edupath.student.summary.name"></s:text>  
							</label>
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm" name="name"
									id="nametxt" value="%{studentDTO.name}" autocomplete="off" />
						...
						<div class="form-group">
							<label class="control-label col-md-3"> <s:text
									name="com.edupath.student.detail.gender"></s:text> 
							</label>
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm" name="gender" id="gendertxt"
									  value="%{studentDTO.gender}"  autocomplete="off" />
						...
						<div class="form-group">
							<label class="control-label col-md-3"> <s:text
									name="com.edupath.student.detail.city"></s:text> 
							</label>
							<div class="col-md-4">
						...
						<div class="form-group">
							<label class="control-label col-md-3"> <s:text
									name="com.edupath.student.detail.school"></s:text> 
							</label>
							<div class="col-md-4">
						...
						<div class="form-group">
							<label class="control-label col-md-3"> <s:text
									name="com.edupath.student.detail.class"></s:text> 
							</label>
							<div class="col-md-4">
								<select name="classId" id="classIdtxt" class="form-control input-sm" onchange="fnchangeRequiredField(this.value);" >
						...
						<div class="form-group" >
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm"
									name="studentemailId" id="studentemailIdtxt"
						...
						<div class="form-group" > 
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm"
									name="studentcontactNumber" id="studentcontactNumbertxt"
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm" name="fathername"
									id="fathernametxt" value="%{studentDTO.fatherName}"
									autocomplete="off" />
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm"
									name="fatheremailId" id="fatheremailIdtxt"
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm"
									name="contactNumber" id="contactNumbertxt"
						...
						<div class="form-group " >
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm"
									name="motherName" id="motherNametxt"
						...
						<div class="form-group ">
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm"
									name="motheremailId" id="motheremailIdtxt"
						...
						<div class="form-group ">
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm"
									name="mothercontactno" id="mothercontactnotxt"
						...
						<div class="form-group">
							<label class="control-label col-md-3"> <s:text
									name="com.edupath.student.detail.computerfacility"></s:text> 
							</label>
							<div class="col-md-4">
						...
						<div class="form-group">
							<label class="control-label col-md-3"> <s:text
									name="com.edupath.student.detail.type"></s:text> 
							</label>
							<div class="col-md-4">
									<c:choose>
						...
						<div class="row test-cls" style="display: ${displayTest}">
							<label class="control-label col-md-3"> <s:text
									name="com.edupath.student.detail.test"></s:text> 
							</label>
							<div class="col-md-4">
						...
						<div class="row session-cls" style="display: ${display}">
							<div class="col-md-6">
								<div class="form-group">
									...
									<label class="control-label col-md-6"><s:text
											name="com.edupath.student.summary.agreedAmount" />   </label>
									<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									<button type="button" class="btn blue" onclick="fnSubmit();">
										...
										<s:text name="com.edupath.common.label.convert" />
									</button>
...
function goBack() {
	form.action = "${pageContext.request.contextPath}/myapp/DHScheduleAction";
	form.submit();
}
...
$(document).ready(function() {
	...
	$("#nametxt").prop("disabled", true);
	$("#gendertxt").prop("disabled", true);
	$("#classIdtxt").prop("disabled", true);
	$("#sectiontxt").prop("disabled", true);
	$("#studentemailIdtxt").prop("disabled", true);
	$("#studentcontactNumbertxt").prop("disabled", true);
	$("#fathernametxt").prop("disabled", true);
	$("#fatheremailIdtxt").prop("disabled", true);
	$("#contactNumbertxt").prop("disabled", true);
	$("#motherNametxt").prop("disabled", true);
	$("#motheremailIdtxt").prop("disabled", true);
	$("#mothercontactnotxt").prop("disabled", true);
	$('.session3').hide();
...
function fnSubmit() {
	if (isValidate()) {
		...
		$("#studentemailId").prop("disabled", false);
		$("#studentcontactNumber").prop("disabled", false);
		$("#fathername").prop("disabled", false);
		$("#fatheremailId").prop("disabled", false);
		$("#contactNumber").prop("disabled", false);
		$("#motherName").prop("disabled", false);
		$("#motheremailId").prop("disabled", false);
		$("#mothercontactno").prop("disabled", false);*/
		if (id != '' && id != '0') {
			form.action = "${pageContext.request.contextPath}/myapp/insertDHStudentConversionsubmit";
		} else {
			form.action = "${pageContext.request.contextPath}/myapp/insertDHStudentConversionsubmit";
		}
		form.submit(); 
...
function isValidate() 
{
	...
	var session3_date = $.trim($('#session2_date').val());
	var session3_time = $.trim($('#session2_time').val());
	...
	console.log("bharath out of isvalidate")
	return true;
}
