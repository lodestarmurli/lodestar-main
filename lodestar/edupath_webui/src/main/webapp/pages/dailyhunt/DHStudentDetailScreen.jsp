				...
				<s:form cssClass="form-horizontal" name="studentSubmitForm"
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<s:textfield cssClass="form-control input-sm" name="gender" id="gender"
...
$(document).ready(function() {
	var redioShowval = $.trim($('#redioShow').val());
	var redioShowval2 = $.trim($('.redioShow').val());
	...
	$("#studentemailId").prop("disabled", true);
	$("#studentcontactNumber").prop("disabled", true);
	$("#fathername").prop("disabled", true);
	$("#fatheremailId").prop("disabled", true);
	$("#contactNumber").prop("disabled", true);
	$("#motherName").prop("disabled", true);
	$("#motheremailId").prop("disabled", true);
	$("#mothercontactno").prop("disabled", true);
	$('.session3').hide();
...
function isSessionValid(session1_date, session1_time, session2_date,
	...
	if(!checkDate(session1, session2,   session1_date, session2_date ))
		{
			return false;
		}
...
function checkDate(session1, session2,   session1_date, session2_date)
{
