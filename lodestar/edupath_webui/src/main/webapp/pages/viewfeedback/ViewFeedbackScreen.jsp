	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-edit"></i><s:text name="com.edupath.viewfeedback.title"></s:text>
				</div>			
			</div>
			  ...
			  <s:if test="hasActionErrors()">
				...
				<div class="table-toolbar">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="feedback-tabs-div">
					       		<div class="tabbable">
					       			<ul class="nav nav-tabs">
					       				<li class="active" id="studentTabId" data-feedback-type="student" data-div-id="studentFeedbackId">
					       					<a data-toggle="tab" href="#studentFeedbackId">
					       						<s:text name="com.edupath.viewfeedback.tab.lable.student"/>
					       					</a>
					       				</li>
					       				<li id="parentTabId1" data-feedback-type="parent" data-div-id="parentFeedbackId1">
					       					<a data-toggle="tab" href="#parentFeedbackId1">
					       						<s:text name="com.edupath.viewfeedback.tab.lable.parent"/>
					       					</a>
					       				</li>
					       			</ul>
					       			...
					       			<ul class="nav nav-tabs" style="display:none;" id="newparentid">
					       				<li class="active" id="parentTabId2" data-feedback-type="parent2" data-div-id="parentFeedbackId">
					       					<a data-toggle="tab" href="#parentFeedbackId2">
					       						<s:text name="com.edupath.viewfeedback.tab.lable.parentsessionone"/>
					       					</a>
					       				</li>
					       				<li id="parentTabId3" data-feedback-type="parent3" data-div-id="parentFeedbackId">
					       					<a data-toggle="tab" href="#parentFeedbackId3">
					       						<s:text name="com.edupath.viewfeedback.tab.lable.parentsessiontwo"/>
					       					</a>
					       				</li>
					       				<li id="parentTabId" data-feedback-type="parent" data-div-id="parentFeedbackId">
					       					<a data-toggle="tab" href="#parentFeedbackId">
					       						<s:text name="com.edupath.viewfeedback.tab.lable.parentfinalfeedback"/>
					       					</a>
					       				</li>
					       			</ul>
				...
				<div class="row" style="padding: 0 10px;">
				 	<div class="col-md-12">
				       ...
				       <div class="viewfeedback" style="display: inline-block;">
				       ...
				       <div class="export" style="display: inline-block;margin-top:5px;">       <!--margin-left: 330px;  21/03/18--->
...
var oTable;
	...
	function loadFeedback(feedbackType, divId)
	{
		if(fnIsValid())
		{
			...
			$('#feedbackType').val(feedbackType);
			var url = "${pageContext.request.contextPath}/myapp/getFeedbackByFilterViewFeedbackAction";
	...
	function fnExportToExcel()
	{
		...
		form.action = "${pageContext.request.contextPath}/myapp/getReportFeedbackExportExcelReportAction";
		form.submit();
	}
</script>