...
public class PaymentBulkUploadProcessor {
	private static final Logger						OUT				= LoggerFactory.getLogger(PaymentBulkUploadProcessor.class);

private static final PaymentBulkUploadProcessor	instance		= new PaymentBulkUploadProcessor();
...
private boolean									inProgress;
	...
	public static PaymentBulkUploadProcessor getInstance()
	{
		return instance;
	}
	...
	private class EduPathBulkUploadJob implements Callable<BulkUploadMessage>
	{
		...
		public BulkUploadMessage call()
		{
			...
			try
			{
				...
				isValidationSuccess =new PaymentExcelValidator().validate(xlsEngine, excelRowObjList);
				...
				EActionStatus persistStatus = new PaymenttExcelUploadDBUtil().persistExcelObjects(xlsEngine, excelRowObjList, loggedInUserLoginId);
