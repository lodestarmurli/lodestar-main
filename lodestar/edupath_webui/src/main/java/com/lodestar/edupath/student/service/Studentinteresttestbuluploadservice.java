...
public class Studentinteresttestbuluploadservice {
	public static Logger OUT = LoggerFactory.getLogger(Studentinteresttestbuluploadservice.class);
	...
	private void sendNotification(StudentDetailsDTO studentDetailsDTO, SessionScheduleDetailsDTO seDetailsDTO,
		...
		if (isNew) {
			...
			tempalteName = NotificationConstant.MessageTemplateNameAndType.NEW_STUDENT.name();
			tempalteNameParent = NotificationConstant.MessageTemplateNameAndType.NEW_STUDENT.name();
		...
		boolean checkIsStudentSameid=true;
		if(ParentEmailID!=null)
		{
			...
			if (StudentEmailID != null && checkIsStudentSameid) {
	...
	private void sendNotificationForTrialStudent(StudentDetailsDTO studentDetailsDTO,
		...
		parameterMap.put("parentName", studentDetailsDTO.getFathername());
		if (isNew) {
			tempalteName = NotificationConstant.MessageTemplateNameAndType.TRIAL_TO_FULL_STUDENT.name();
		}
		if (testTaken) {
