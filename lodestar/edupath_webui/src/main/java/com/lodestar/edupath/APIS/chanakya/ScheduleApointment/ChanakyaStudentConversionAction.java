...
public class ChanakyaStudentConversionAction extends BaseAction implements ModelDriven<StudentBean>
{

	private static final long			serialVersionUID	= 6090415257988873149L;
	private static Logger				OUT					= LoggerFactory.getLogger(ChanakyaStudentConversionAction.class);
	...
	private ChanakyaStudentConversionService	service1;

	public ChanakyaStudentConversionAction()
	{
		service = new StudentDetailService();
		service1 = new ChanakyaStudentConversionService();
	}
