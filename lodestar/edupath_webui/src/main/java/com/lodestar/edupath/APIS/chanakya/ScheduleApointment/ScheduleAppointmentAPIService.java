...
import com.lodestar.edupath.dataaccessobject.dao.APIS.chanakya.ChanakyaStudentExtraDetailsDAO;
...
public class ScheduleAppointmentAPIService {
	...
	public List<ChanakyaStudentExtraDetailDTO>  getAllChanakyaStudentExtraDetails()
	{
		...
		List<ChanakyaStudentExtraDetailDTO> resultDTO = new ArrayList<ChanakyaStudentExtraDetailDTO>();
		ChanakyaStudentExtraDetailsDAO dhStudentExtraDetailDAO = new ChanakyaStudentExtraDetailsDAO();
		session = MyBatisManager.getInstance().getSession();
		try {
			//dhstudentDTO.setDHID(id.trim());
			session = MyBatisManager.getInstance().getSession();
			resultDTO = dhStudentExtraDetailDAO.getAllChanakyaStudentExtraDetails();
			
			session.commit();
			for(ChanakyaStudentExtraDetailDTO studentdto : resultDTO)
			{
