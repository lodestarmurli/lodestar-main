...
public class StudentIndividualVO implements Serializable
{
	...
	public String toString() {
		return "StudentIndividualVO [id=" + id + ", userId=" + userId + ", isDelete=" + isDelete + ", studentTypeStr="
				...
				+ session3DateStr + ", venue=" + venue + ", loginId=" + loginId + ", passwordStr=" + passwordStr
				+ ", dueAmount=" + dueAmount + ", facilitatorId=" + facilitatorId + ", reportGenerated="
				+ reportGenerated + ", isActive=" + isActive + ", preSessionCompleted=" + preSessionCompleted
				+ ", session1FaciCompleted=" + session1FaciCompleted + ", session2FaciCompleted="
				+ session2FaciCompleted + ", session3FaciCompleted=" + session3FaciCompleted + ", facilitatorName="
				+ facilitatorName + "]";
	}
