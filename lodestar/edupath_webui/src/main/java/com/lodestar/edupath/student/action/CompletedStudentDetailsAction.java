...
import com.lodestar.edupath.student.service.CompletedStudentDetailService;
...
public class CompletedStudentDetailsAction extends BaseAction implements ModelDriven<StudentDetailsDTO>
{

	private static final long		serialVersionUID	= 4107476161853263600L;
	private static Logger			OUT					= LoggerFactory.getLogger(CompletedStudentDetailsAction.class);
	...
	private CompletedStudentDetailService	service;
	private int 						userId;	
	...
	public CompletedStudentDetailsAction()
	{
		service = new CompletedStudentDetailService();
	}

	@Override
	public String execute() throws Exception
	{
		OUT.debug("Excute  the CompletedStudentDetailsAction Summary Action Of======================= {}", CompletedStudentDetailsAction.class);
...
//			List<StudentVO> finalList = service.getAllStudentSummary(dataTableVO);
			List<StudentVO> finalList = service.getAllStudentSummaryNew(dataTableVO);
...
//			JSONObject jsonObj=(JSONObject) finalList;
	...
	{
		OUT.debug("CompletedStudentDetailsAction : inside openSession method");
		userId = Integer.parseInt(request.getParameter("userId"));
	...
	public String delete() throws Exception
	{
		...
		OUT.debug("CompletedStudentDetailsAction : inside delete method");
		userId = Integer.parseInt(request.getParameter("userId"));
		studentId = Integer.parseInt(request.getParameter("studentId"));
		openSessionType = request.getParameter("openSessionType");
