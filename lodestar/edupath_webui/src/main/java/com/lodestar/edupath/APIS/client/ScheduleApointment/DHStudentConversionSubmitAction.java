...
public class DHStudentConversionSubmitAction extends BaseAction implements ModelDriven<StudentDetailsDTO> 
{
	private static final long serialVersionUID = 4228877756086138530L;
	private static Logger OUT = LoggerFactory.getLogger(DHStudentConversionSubmitAction.class);
	...
	private DHStudentConversionSubmitService service;
	...
	public DHStudentConversionSubmitAction() {
		service = new DHStudentConversionSubmitService();
	}
