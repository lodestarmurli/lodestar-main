...
public class StudentBulkUploadProcessor
{
	private static final Logger						OUT				= LoggerFactory.getLogger(StudentBulkUploadProcessor.class);

	private static final StudentBulkUploadProcessor	instance		= new StudentBulkUploadProcessor();
	...
	public static StudentBulkUploadProcessor getInstance()
	{
		return instance;
	}
...
//				Map<String, StudentDetailsDTO> userLoginIdNIdMap = new StudentDetailService().getStudentMapForIntersetTestBulk();
				...
				isValidationSuccess = new StudentExcelValidator().validate(xlsEngine, excelRowObjList, cityList, schoolList, classList, facilitatorList);
				...
				EActionStatus persistStatus = new StudentExcelUploadDBUtil().persistExcelObjects(xlsEngine, excelRowObjList, cityList, schoolList, classList, facilitatorList,loggedInUserName);
