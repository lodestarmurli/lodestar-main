...
public class StudentArchiveVO implements Serializable
{
	...
	public String toString() {
		return "StudentArchiveVO [id=" + id + ", userId=" + userId + ", isDelete=" + isDelete + ", studentTypeStr="
				...
				+ session2FaciCompleted + ", session3FaciCompleted=" + session3FaciCompleted + "]";
	}
