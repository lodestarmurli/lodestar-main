...
public class FacilitatorDetailsAction extends BaseAction implements ModelDriven<FacilitatorDetailsDTO>
{

	private static final long			serialVersionUID		= 1L;
	private static final Logger			OUT						= LoggerFactory.getLogger(FacilitatorDetailsAction.class);
	...
	{
		OUT.info("Getting all Facilitator Details list");
		try
		{
			facilitatorDetailsList = new FacilitatorDetailsService().getAllFacilitatorDetails();
		}
		catch (Exception e)
		{
	...
	public String getData()
	{
		...
		//================ Sasedeve edited by vyankatesh on =================================
